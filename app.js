...
const projects = [
  {
    ...
    type: "Business",
    description: "Modern site for a growth-focused consulting firm.",
    url: "#",
    theme: "business",
    icon: "briefcase",
  },
  ...
  },
  {
    ...
    type: "Portfolio",
    description: "Elegant portfolio for a multidisciplinary creator.",
    url: "#",
    theme: "portfolio",
    icon: "user",
  },
  {
    ...
    type: "Booking",
    description: "Seamless booking experience for clients.",
    url: "#",
    theme: "booking",
    icon: "calendar",
  },
  {
    title: "Local Service Site",
    type: "Business",
    description: "Trust-building site for a local service provider.",
    url: "#",
    theme: "local",
    icon: "pin",
  },
  {
    title: "AI Tool Page",
    type: "Business",
    description: "Product page for an AI-powered web app.",
    url: "#",
    theme: "ai",
    icon: "spark",
  },
